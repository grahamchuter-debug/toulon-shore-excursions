...
const path = "/guides";
const description =
  "Toulon and Provence cruise planning guides — historic harbour, Cassis, Bandol, Mont Faron and practical port-day advice.";

export const metadata = buildMetadata({
  title: "Toulon & Provence Cruise Planning Guides",
  description,
  path,
  keywords: [
    "Toulon cruise port guide",
    "Cassis from Toulon",
    "Toulon shore excursions guide",
    "Mont Faron from Toulon",
    "Provence cruise guide",
  ],
});
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({ title: "Toulon & Provence Cruise Planning Guides", description, path }),
        ]}
      />
      <PageHero
        title="Toulon & Provence Planning Guides"
        subtitle="Your gateway to authentic Toulon, Cassis, Bandol and inland Provence — practical advice for every type of cruise passenger."
      ...
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="section-subtitle">Practical guides to Provençal highlights with transfer times and return-to-ship advice.</p>
