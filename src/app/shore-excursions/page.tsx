...
export const metadata = buildMetadata({
  title: "Toulon Shore Excursions — Provence from Your Cruise Ship",
  description:
    "Carefully selected Toulon shore excursions to Cassis, Bandol, Luberon villages and Provence beyond the city, with cruise-aware timing.",
  path: "/shore-excursions",
  image: excursionsHubImage.src,
  imageAlt: excursionsHubImage.alt,
  keywords: [
    "Toulon shore excursions",
    "Cassis from Toulon cruise",
    ...
    <>
      <JsonLd
        data={[
          ...
          webPageSchema({
            title: "Toulon Shore Excursions",
            description: "Carefully selected Provence shore excursions from Toulon cruise port.",
            path: "/shore-excursions",
          }),
        ]}
      />
      <PageHero
        ...
        title="Toulon Shore Excursions"
        subtitle="Cruise-timed tours for your chosen Provence — Cassis, Bandol, Luberon villages, historic Toulon and coastal experiences with reliable return-to-ship planning."
        compact
      />
      <section className="section-padding">
        <div className="container-wide">
          ...
          <p className="mt-6 text-gray-600">
            ...
            <Link href="/compare/city-or-provence" className="font-semibold text-coastal-700 hover:underline">
              city or Provence comparison
            </Link>{" "}
            or the{" "}
