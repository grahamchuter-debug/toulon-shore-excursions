...
export const metadata = buildMetadata({
  title: "Toulon Cruise Ship Schedules",
  description:
    "Toulon cruise ship schedules by year and month. See which ships call before booking Cassis, Bandol or city excursions.",
  path,
  keywords: ["Toulon cruise ship schedule", "Toulon cruise calendar", "Toulon ship schedule"],
});
...
export default function ShipSchedulesPage() {
  return (
    <>
      <JsonLd data={[breadcrumbSchema(breadcrumbs), webPageSchema({ title: "Toulon Cruise Ship Schedules", description: "Toulon cruise ship schedules by year and month.", path })]} />
      <PageHero title="Toulon Cruise Ship Schedules" subtitle="See which ships are in port before you book Provence excursions. Times and berths are indicative — always confirm with your cruise line." compact />
