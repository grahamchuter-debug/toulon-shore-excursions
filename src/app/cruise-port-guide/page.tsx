...
const description =
  "The complete Toulon cruise port guide — terminal layout, walking routes, taxis, old town access and return-to-ship timing.";
...
export const metadata = buildMetadata({
  ...
  image: image.src,
  imageAlt: image.alt,
  keywords: ["Toulon cruise port", "Toulon cruise terminal", "Toulon port to old town", "Toulon cruise port guide"],
});

const breadcrumbs = [
  { name: "Home", path: "/" },
  { name: "Toulon Cruise Port Guide", path },
];
    ...
    <>
      ...
      <section className="section-padding">
        <div className="container-wide max-w-4xl">
          ...
          <div className="mt-12">
            <FAQSection faqs={portGuideFaqs} title="Toulon port FAQs" />
          </div>
