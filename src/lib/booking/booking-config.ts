/**
 * Booking engine configuration — Toulon multi-product checkout experience.
 */
...
export const bookingPrototypeTour: BookingTourView = (() => {
  const first = getBookableProduct("discover-cassis-calanques-provence-wine-tasting");
...
export const bookingPricingConfig = {
  ...
  priceConfigured: Boolean(getBookableProduct("discover-cassis-calanques-provence-wine-tasting")),
  ...
  returnGuaranteeDetail:
    "Your itinerary is planned to return you to Toulon with time before your ship departs.",
...
export const bookingCheckoutCopy = {
  ...
  reconnectLine: "Your Provence day is almost booked.",
