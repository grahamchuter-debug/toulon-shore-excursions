...
function MarkSvg({
  ...
  // Concept A (active): Anchor Arch — Provençal harbour mark meeting a restrained anchor.
  return (
    <svg
      width={size}
      height={size}
 ...
 *
 * Logo refinement: icon slightly subordinate to TOULON,
...
export function DestinationLogo({
  ...
  const onDark = tone === "on-dark";
  // ~12% smaller than the first prototype so TOULON stays dominant
