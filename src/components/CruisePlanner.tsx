...
export function CruisePlanner() {
  ...
  const [interests, setInterests] = useState<string[]>(["old-town", "independent"]);
  ...
  function downloadPdf() {
    ...
    doc.save("toulon-cruise-plan.pdf");
  }
  ...
  return (
    <div className="card-feature">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button type="button" onClick={generate} className="btn-primary">Build my Toulon plan</button>
      ...
      {plan && (
        <div className="mt-8 space-y-8">
          ...
          <p className="text-xs text-gray-500">Guidance is indicative — always confirm your ship&apos;s all-aboard time and build a 60–90 minute return buffer. Traffic on coastal roads toward Cassis, Bandol and inland Provence can lengthen journey times.</p>
        </div>
      )}
    </div>
  );
