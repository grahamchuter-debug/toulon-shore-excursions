  ...
  return (
    <section className="section-padding bg-coastal-50 border-b border-coastal-100">
      <div className="container-wide max-w-4xl">
        <p className="section-eyebrow">Toulon cruise port ratings</p>
        <h2 className="section-title mt-2">How Toulon scores for cruise passengers</h2>
        <p className="section-subtitle">
          Editorial ratings based on walkability, Provençal character, food culture, scenery and how well
